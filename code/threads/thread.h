...
class Thread {
  ...
  public:
    ...
    int getThreadNum();         //added by lg, 2017.0524
  ...
  private:
    ...
    static int threadNum;      //control the  number of the thread ,lianggang added
...
// while executing kernel code.
  ...
  public:
    ...
    int priority;             //set the priority for the thread, added by lg 2017.05.24
